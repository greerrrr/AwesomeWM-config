...
--  Scrolling through desktops is not useful
--  awful.button({}, 4, awful.tag.viewnext),
--  awful.button({}, 5, awful.tag.viewprev)
))
...
globalkeys = awful.util.table.join(
    ...
    awful.key({modkey, "Control"}, "Left", shifty.send_prev), -- client to prev tag
    awful.key({modkey, "Control"}, "Right", shifty.send_next), -- client to next tag
...
clientkeys = awful.util.table.join(
    ...
    awful.key({modkey, "Control"}, "space",
		...
		c.ontop = awful.client.floating.get()
    	end),
